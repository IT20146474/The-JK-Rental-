...
<head>
	...
	<title>THE JK RENTAL | Admin Post Vehicle</title>
...
<br>
		...
		<button  style="background-color: #940606;  border: none;  color: white;  padding: 15px 32px;  text-align: center;  text-decoration: none; display: inline-block;  font-size: 16px;  margin: 4px 2px;  cursor: pointer;"class="btn btn-default" type="reset">Cancel</button>

		<button style="background-color: #24119e;  border: none;  color: white;  padding: 15px 32px;  text-align: center;  text-decoration: none; display: inline-block;  font-size: 16px;  margin: 4px 2px;  cursor: pointer;"class="btn btn-primary" name="submit" type="submit">Post </button>
