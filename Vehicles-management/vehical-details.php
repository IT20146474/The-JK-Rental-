...
<title>THE JK RENTAL| Vehicle Details</title>
<!--Bootstrap -->
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <label for="fromdate">NIC:</label>
              <input type="text" class="form-control" name="fromdate" placeholder="Enter Your NIC Number" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input tel ="4" class="form-control" name="message"  placeholder="712345678" pattern="[0-9]{3}[0-9]{3}[0-9]{3}" required>
            </div>
